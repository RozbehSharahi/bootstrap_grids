tx_gridelements {
	...
	setup {
		...
		1col {
			title = LLL:EXT:bootstrap_grids/Resources/Private/Language/locallang_db.xlf:1col.title
			description = LLL:EXT:bootstrap_grids/Resources/Private/Language/locallang_db.xlf:1col.description
			icon = EXT:bootstrap_grids/Resources/Public/Icons/gridlayout_col1.gif
			...
			config {
				...
				rows.1 {
					columns {
						1 {
							name = LLL:EXT:bootstrap_grids/Resources/Private/Language/locallang_db.xlf:celayout.column
							colPos = 101
						}
					}
				}
			}
			flexformDS = FILE:EXT:bootstrap_grids/Configuration/FlexForm/flexform_1col.xml
			#flexformDS (
			#<?xml...
			#)
		}
